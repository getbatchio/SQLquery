...
$query = 'SELECT c.customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone from customers c
INNER join addresses a 
on c.customerID = a.customerID
GROUP BY c.customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone'
